...
# Выводы
1. Была выбрана наиболее оптимальная гипотеза.
2. На основании анализа мной было принято решение о нецелесообразности дальнейшего проведения теста.
# Данные
Файл 'hypothesis.csv':
...
*pandas, numpy, matplotlib, scipy, warnings*
